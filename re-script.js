...
const FALLBACK_DATA = [
  {
    ...
    MarketValue: "$6,330,800", ARV: "$9,200,000", BuyIn: "$5,200,000", InvestmentStrategy: "Call Me",
    CapRate: "Call Me", GRM: "Call Me", RehabBudget: "$1,500,000", EstRentCashFlow: "Call Me",
